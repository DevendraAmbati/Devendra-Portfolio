    ...
    <section id="services" className="my-16 px-4 md:px-8">
      ...
      <div className="space-y-20 mt-10 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent">
        ...
        <ServiceCard
          ...
          description={
            <>
              ...
              . I focus on delivering pixel-perfect, accessible, and
              mobile-friendly designs using{" "}
              <span className="font-semibold text-[#9aa6ff]">Tailwind CSS</span>{" "}
              and{" "}
              <span className="font-semibold text-[#9aa6ff]">Bootstrap</span>.
            </>
          }
        />
        ...
        <ServiceCard
          ...
          description={
            <>
              ...
              , Context API, and efficient state management. Integrating RESTful
              APIs to ensure dynamic and seamless user experiences.
            </>
          }
        />
        ...
        <ServiceCard
          ...
          description={
            <>
              Developing scalable and secure single-page applications (SPAs)
              with features like{" "}
              <span className="font-semibold text-[#9aa6ff]">
